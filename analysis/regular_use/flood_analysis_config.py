...
EVENT_CONFIG = {
    "Somerset_Winter201314": { # will need more specific event names for different versions of Somerset setup
        "base_path": Path(
            "/home/azureuser/cloudfiles/code/Users/eloise.matthews/03_Runs/somerset/"
        ),
        "factual": "SomersetLevels_dec/sfincs/event_tp_ceh_gear_hourly_factual_CF0_GTSMv41opendap_CF0_no_wind_CF0",  # subfolder name for each scenario provided in SCENARIOS list - keys must match scenario names
        "counterfactual": "SomersetLevels_dec/sfincs/event_tp_ceh_gear_hourly_counterfactual_CF0_GTSMv41opendap_CF0_no_wind_CF0",
        "future": "SomersetLevels_dec/sfincs/event_tp_ceh_gear_hourly_future_CF0_GTSMv41opendap_CF0_no_wind_CF0",
        "title": "Somerset Winter 2013/14",
        "domain": somerset_domain,
        "shapefile": Path(
            "/home/azureuser/cloudfiles/code/Users/eloise.matthews/local_data/static/somerset_shape/new_shape2.shp"
        ),
    },
}
