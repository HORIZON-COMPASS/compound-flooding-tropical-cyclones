...
OUTPUT_DIR = Path(
    "/home/azureuser/cloudfiles/code/Users/eloise.matthews/regular_analysis/"
)
...
# Make subdirectory called EVENT_NAME for this event's outputs
...
# Save to CSV
output_file_csv = (
    event_output_dir / f"sfincs_{EVENT_NAME.lower()}_flood_aggregated_data_reformatted.csv"
)
...
output_file_agg_bar = bar_charts(
    SCENARIOS, area_m2, volume_m3, EVENT_TITLE, EVENT_NAME, event_output_dir
)


# ===== CLEANUP =====
print(
    f"\nAnalysis complete for {EVENT_NAME}! Check the saved PNG files in: {event_output_dir}"
)
print("Files created:")
