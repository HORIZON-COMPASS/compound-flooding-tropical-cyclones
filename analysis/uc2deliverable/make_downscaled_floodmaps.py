...
# ── CONFIGURATION ─────────────────────────────────────────────────────────────
RUN_DIR = Path("/home/azureuser/cloudfiles/code/Users/eloise.matthews/output_jul26/t1") # change between t1/factual/t3

MAP_NC      = RUN_DIR / "sfincs_map.nc"
DEP_SUBGRID = RUN_DIR / "dep_subgrid.tif"
...
OUT_ROOT = Path("/home/azureuser/cloudfiles/code/Users/eloise.matthews/data/output_jul26")
OUT_DIR  = OUT_ROOT / "t1_downscaled" # change between t1/factual/t3

# Permanent-water mask.  None to skip.
GSWO_PATH        = Path("/home/azureuser/cloudfiles/code/Users/eloise.matthews/local_data/static/occur.tif") # original file here was .vrt but we have a .tif
GSWO_MAX_OCCUR   = 5      # mask where occurrence > this (%)
EXPORT_GSWO_MASK = True   # also write the clipped mask, for sharing

HMIN = 0.3   # m — passed to downscale_floodmap
