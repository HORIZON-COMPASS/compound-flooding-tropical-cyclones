...
sfincs_dir_CF = BASE_RUN_PATH / "sfincs" / "event_tp_era5_hourly_zarr_CF-6_GTSMv41_CF-0.07_era5_hourly_spw_IBTrACS_CF-4"
...
#%%
# Path_pop_fine_GHSL_100m_regridded_2015 = "p:/11210471-001-compass/01_Data/population_data/downscaled/population_GHSL_100m_2015_region_regrid.tif"
# # Path_pop_fine_GHSL_100m_regridded_2020 = "p:/11210471-001-compass/01_Data/population_data/downscaled/population_GHSL_100m_2020_region_regrid.tif"

# with rasterio.open(Path_pop_fine_GHSL_100m_regridded_2015) as src_id:
#         pop_fine_GHSL_100m_regridded_2015 = src_id.read(1)
#         Path_pop_fine_GHSL_100m_regridded_2015_transform = src_id.transform
#         Path_pop_fine_GHSL_100m_regridded_2015_crs = src_id.crs

# with rasterio.open(Path_pop_fine_GHSL_100m_regridded_2020) as src_id:
#         pop_fine_GHSL_100m_regridded_2020 = src_id.read(1)
#         Path_pop_fine_GHSL_100m_regridded_2020_transform = src_id.transform
#         Path_pop_fine_GHSL_100m_regridded_2020_crs = src_id.crs

# print("Differences in population counts between GLOPOP-SG and HANZE regridded:")
# print(f"2015 - GLOPOP-SG: {pop_fine_glopop.sum()}, HANZE: {pop_fine_GHSL_100m_regridded_2015.sum()}")
# # print(f"2019 - GLOPOP-SG: {pop_fine_glopop.sum()}, HANZE: {pop_fine_GHSL_100m_regridded_2020.sum()}")
# print(f"% difference 2015 (GLOPOP-SG/HANZE): {pop_fine_glopop.sum() / pop_fine_GHSL_100m_regridded_2015.sum() * 100:.2f} %")
# # print(f"% difference 2019 (GLOPOP-SG/HANZE): {pop_fine_glopop.sum() / pop_fine_GHSL_100m_regridded_2020.sum() * 100:.2f} %")
...
# gdf_pop_ghsl_100m_2015_F_coarse  = aggregate_exposed_pop_to_grid_id(pop_fine_GHSL_100m_regridded_2015, hmax_F, grid_id_fine_glopop)
# gdf_pop_ghsl_100m_2020_F_coarse  = aggregate_exposed_pop_to_grid_id(pop_fine_GHSL_100m_regridded_2020, hmax_F, grid_id_fine_glopop)
...
#%%
# def plot_exposed_population_by_category_spatially(
#     df,
#     category,
#     label_dict,
#     grid_id_crs,
...
#     sm._A = []
#     cbar = fig.colorbar(sm, ax=axes, shrink=0.6, pad=0.02)
#     cbar.set_label("Population exposed per grid cell")
...
# plot_exposed_population_by_category_spatially(pop_charac_exposed_F, 'WEALTH',     wealth_labels, grid_id_crs, grid_ids, grid_id_transform, region, background_utm, flood_extent)
# plot_exposed_population_by_category_spatially(pop_charac_exposed_F, 'RURAL',      rural_labels,  grid_id_crs, grid_ids, grid_id_transform, region, background_utm, flood_extent)
# plot_exposed_population_by_category_spatially(pop_charac_exposed_F, 'AGE',        age_labels,    grid_id_crs, grid_ids, grid_id_transform, region, background_utm, flood_extent)
# plot_exposed_population_by_category_spatially(pop_charac_exposed_F, 'GENDER',     gender_labels, grid_id_crs, grid_ids, grid_id_transform, region, background_utm, flood_extent)
# plot_exposed_population_by_category_spatially(pop_charac_exposed_F, 'EDUC',       educ_labels,   grid_id_crs, grid_ids, grid_id_transform, region, background_utm, flood_extent)
# plot_exposed_population_by_category_spatially(pop_charac_exposed_F, 'HHSIZE_CAT', hhsize_labels, grid_id_crs, grid_ids, grid_id_transform, region, background_utm, flood_extent)
...
#%%
# from matplotlib.colors import LinearSegmentedColormap
# def plot_diff_exposed_population_by_category_spatially(
#     df_f,
#     df_cf,
#     category,
#     label_dict,
...
# plot_diff_exposed_population_by_category_spatially(pop_charac_exposed_F, pop_charac_exposed_CF, 'WEALTH',     wealth_labels, grid_id_crs, grid_ids, grid_id_transform, region, background_utm, flood_extent)
# # plot_diff_exposed_population_by_category_spatially(pop_charac_exposed_F, pop_charac_exposed_CF, 'RURAL',      rural_labels,  grid_id_crs, grid_ids, grid_id_transform, region, background_utm, flood_extent)
# plot_diff_exposed_population_by_category_spatially(pop_charac_exposed_F, pop_charac_exposed_CF, 'AGE',        age_labels,    grid_id_crs, grid_ids, grid_id_transform, region, background_utm, flood_extent)
# plot_diff_exposed_population_by_category_spatially(pop_charac_exposed_F, pop_charac_exposed_CF, 'GENDER',     gender_labels, grid_id_crs, grid_ids, grid_id_transform, region, background_utm, flood_extent)
# plot_diff_exposed_population_by_category_spatially(pop_charac_exposed_F, pop_charac_exposed_CF, 'EDUC',       educ_labels,   grid_id_crs, grid_ids, grid_id_transform, region, background_utm, flood_extent)
# plot_diff_exposed_population_by_category_spatially(pop_charac_exposed_F, pop_charac_exposed_CF, 'HHSIZE_CAT', hhsize_labels, grid_id_crs, grid_ids, grid_id_transform, region, background_utm, flood_extent)
...
flood_bins_edges = [0.15, 0.5, 1.5, 3.5]  # Low <0.5m, Medium 0.5–1.5m, High >1.5m
...
#     tick_bins = np.arange(0.15, 3.5 + 0.5, 0.5)
...
# Plotting masks for different flood depth ranges (low, moderate, high)
...
# top10_moderate = filtered.sort_values([('Medium', '%')], ascending=False).head(10)
# bottom10_moderate = filtered.sort_values([('Medium', '%')], ascending=True).head(10)
