...
#     print("No-data value World Pop 2020:", src_WP_2020_100m.nodata)
#     pop_WP_2020[pop_WP_2020 == src_WP_2020_100m.nodata] = 0

# with rasterio.open(pop_raster_path_WP_2020_1km) as src_WP_2020_1km:
#     pop_WP_2020, transform_WP_2020 = mask(src_WP_2020_1km, region_geom, crop=True)
#     print("No-data value World Pop 2020:", src_WP_2020_1km.nodata)
#     pop_WP_2020[pop_WP_2020 == src_WP_2020_1km.nodata] = 0

# with rasterio.open(pop_raster_path_WP_2015_1km) as src_WP_2015_1km:
#     pop_WP_2015, transform_WP_2015 = mask(src_WP_2015_1km, region_geom, crop=True)
#     print("No-data value World Pop 2015:", src_WP_2015_1km.nodata)
#     pop_WP_2015[pop_WP_2015 == src_WP_2015_1km.nodata] = 0

# with rasterio.open(pop_raster_path_WP_2019_100m) as src_WP_2019_100m:
#     pop_WP_2019, transform_WP_2019 = mask(src_WP_2019_100m, region_geom, crop=True)
#     print("No-data value World Pop 2019:", src_WP_2019_100m.nodata)
#     pop_WP_2019[pop_WP_2019 == src_WP_2019_100m.nodata] = 0

# with rasterio.open(pop_raster_path_WP_2019_1km) as src_WP_2019_1km:
#     pop_WP_2019, transform_WP_2019 = mask(src_WP_2019_1km, region_geom, crop=True)
#     print("No-data value World Pop 2019:", src_WP_2019_1km.nodata)
#     pop_WP_2019[pop_WP_2019 == src_WP_2019_1km.nodata] = 0
