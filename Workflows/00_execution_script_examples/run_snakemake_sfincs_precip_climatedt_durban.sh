#!/bin/bash
#SBATCH --job-name=durban-climatedt           # Job name
#SBATCH --output=output_log_durban_climatedt_%j.log  # Standard output and error log
...
snakemake --unlock \
    ...
    --configfile ../01_config_snakemake/config_durban_floods_2022_climatedt.yml
...
snakemake \
    ...
    --configfile ../01_config_snakemake/config_durban_floods_2022_climatedt.yml \
    --forceall \
    --rulegraph | dot -Tpng > dag_durban_climatedt.png
