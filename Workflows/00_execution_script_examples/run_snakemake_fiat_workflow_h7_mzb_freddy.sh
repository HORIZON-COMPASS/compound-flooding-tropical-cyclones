...
snakemake --unlock -s snakefile_fiat.smk --configfile ../01_config_snakemake/config_general_mzb_Freddy.yml 

# # running workflow with snakemake
snakemake -s snakefile_fiat.smk --configfile ../01_config_snakemake/config_general_mzb_Freddy.yml --forceall --rulegraph | dot -Tpng > dag_smk_fiat.png
snakemake -s snakefile_fiat.smk --configfile ../01_config_snakemake/config_general_mzb_Freddy.yml --cores 'all' --latency-wait 60 --wait-for-files
