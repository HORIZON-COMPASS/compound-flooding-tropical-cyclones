...
snakemake -s snakefile_all_wflow_sfincs.smk --configfile ../01_config_snakemake/config_general_mzb_Kenneth.yml --cores 'all' --latency-wait 180 --wait-for-files --rerun-incomplete
