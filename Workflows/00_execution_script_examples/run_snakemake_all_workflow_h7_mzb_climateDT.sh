...
snakemake --unlock -s snakefile_all_wflow_sfincs.smk --configfile ../01_config_snakemake/config_general_MZB_ClimateDT.yml 

# # running workflow with snakemake
snakemake -s snakefile_all_wflow_sfincs.smk --configfile ../01_config_snakemake/config_general_MZB_ClimateDT.yml --forceall --rulegraph | dot -Tpng > dag_smk_all.png
snakemake -s snakefile_all_wflow_sfincs.smk --configfile ../01_config_snakemake/config_general_MZB_ClimateDT.yml --cores 'all' --latency-wait 60 --wait-for-files
