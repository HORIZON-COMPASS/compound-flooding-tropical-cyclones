...
snakemake --unlock -s snakefile_wflow.smk --configfile ../01_config_snakemake/config_general_MZB.yml 
...
snakemake -n -s snakefile_wflow.smk --configfile ../01_config_snakemake/config_general_MZB.yml --cores 'all' --latency-wait 60 --wait-for-files --rerun-incomplete # --cores 4
