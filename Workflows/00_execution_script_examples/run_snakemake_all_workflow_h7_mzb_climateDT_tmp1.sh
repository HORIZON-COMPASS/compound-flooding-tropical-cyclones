...
snakemake --unlock -s snakefile_all_wflow_sfincs.smk --configfile ../01_config_snakemake/config_general_MZB_ClimateDT_2deg.yml 

# # running workflow with snakemake
snakemake -s snakefile_all_wflow_sfincs.smk --configfile ../01_config_snakemake/config_general_MZB_ClimateDT_2deg.yml --forceall --rulegraph | dot -Tpng > dag_smk_all.png
snakemake -s snakefile_all_wflow_sfincs.smk --configfile ../01_config_snakemake/config_general_MZB_ClimateDT_2deg.yml --cores 'all' --latency-wait 60 --wait-for-files --rerun-incomplete
