...
# Unlock Snakemake directory - set the configuration file for the Use Case
...
# Running of the workflow - set the configuration file for the Use Case
echo "Running Snakemake..."
snakemake -s snakefile_all_wflow_sfincs.smk --configfile ../01_config_snakemake/config_general_MZB.yml --cores 'all' --latency-wait 60 --wait-for-files --rerun-incomplete
