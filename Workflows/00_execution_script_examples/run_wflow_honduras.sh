...
INPUT_TOML="/p/11210471-001-compass/03_Runs/honduras/EtaIota/wflow_gdlcv3_2019_HND_CF/event_precip_era5_hourly_zarr_CF0_with_runoff_output/events/wflow_sbm.toml"
LOG_FILE="/p/11210471-001-compass/03_Runs/honduras/EtaIota/wflow_gdlcv3_2019_HND_CF/event_precip_era5_hourly_zarr_CF0_with_runoff_output/events/run_default/log.txt"
# Run the Wflow CLI (this corresponds to the Snakemake shell command)
echo "Running Wflow events"
