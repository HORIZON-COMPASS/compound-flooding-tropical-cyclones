#!/bin/bash
# Somerset Dec-2013 — T3 counterfactual (future climate rainfall). Full Wflow + SFINCS pipeline.
# Submit with: sbatch run_snakemake_somerset_dec2013_t3.sh
#SBATCH --job-name=somerset-t3
#SBATCH --output=00_execution_script_examples/logs/slurm/slurm_somerset_t3_%j.log
...
CONFIG=../01_config_snakemake/config_general_somerset_dec2013_t3.yml
