#!/bin/bash
# Durban quick end-to-end test (CF0, 3-hour window) — HydroMT v1 precip-only SFINCS.
# Submit with: sbatch run_snakemake_sfincs_precip_only_durban_quicktest.sh
#SBATCH --job-name=durban-qt
#SBATCH --output=00_execution_script_examples/logs/slurm/slurm_durban_qt_%j.log
...
CONFIG=../01_config_snakemake/config_durban_floods_2022_quicktest.yml
