...
# rule all_dfm:
#     input:
#         # expand(join(root_dir, dir_models, "{region}", "{runname}", "dfm", "base_{bathy}_{tidemodel}_{CF_SLR}", "ext_file_new.ext"), zip, region=region, runname=runname_ids, dfm_res=dfm_res, bathy=bathy, tidemodel=tidemodel, CF_SLR=CF_SLR,) 
#         # expand(join(root_dir, dir_runs, "{region}", "{runname}", "dfm", "event_{dfm_res}_{bathy}_{tidemodel}_{CF_SLR}_{wind_forcing}_{CF_wind}", "event_{dfm_res}_{bathy}_{tidemodel}_{CF_SLR}_{wind_forcing}_{CF_wind}.mdu"), zip, region=region, runname=runname_ids, dfm_res=dfm_res, bathy=bathy, tidemodel=tidemodel, CF_SLR=CF_SLR, wind_forcing=wind_forcing, CF_wind=CF_wind)
#         # expand(join(root_dir, dir_runs, "{region}", "{runname}", "dfm", "event_{dfm_res}_{bathy}_{tidemodel}_{CF_SLR}_{wind_forcing}_{CF_wind}", "output", "event_{dfm_res}_{bathy}_{tidemodel}_{CF_SLR}_{wind_forcing}_{CF_wind}_his.nc"), zip, region=region, runname=runname_ids, dfm_res=dfm_res, bathy=bathy, tidemodel=tidemodel, CF_SLR=CF_SLR, wind_forcing=wind_forcing, CF_wind=CF_wind),
          expand(join(root_dir, dir_runs, "{region}", "{runname}", "dfm", "event_{dfm_res}_{bathy}_{tidemodel}_{CF_SLR}_{wind_forcing}_{CF_wind}", "postprocessing_done.txt"), zip, region=region, runname=runname_ids, dfm_res=dfm_res, bathy=bathy, tidemodel=tidemodel, CF_SLR=CF_SLR, wind_forcing=wind_forcing, CF_wind=CF_wind),   
...
rule make_model_dfm_base:
    ...
    output: 
        dir_model = directory(join(root_dir, dir_models, "{region}", "{runname}", "dfm", "base_{dfm_res}_{bathy}_{tidemodel}_{CF_SLR}")),
        ext_file_new = join(root_dir, dir_models, "{region}", "{runname}", "dfm", "base_{dfm_res}_{bathy}_{tidemodel}_{CF_SLR}", "ext_file_new.ext"),
    script:
...
rule make_dfm_model_event:
    ...
    params:
        tc_name = get_tcname,
        dir_base_model = directory(join(root_dir, dir_models, "{region}", "{runname}", "dfm", "base_{dfm_res}_{bathy}_{tidemodel}_{CF_SLR}")),
        ...
        model_name   = "event_{dfm_res}_{bathy}_{tidemodel}_{CF_SLR}_{wind_forcing}_{CF_wind}",
        dfm_obs_file = get_dfm_obs_points,
        submit_script_file = join(root_dir,dir_runs,"{region}", "{runname}","dfm", "event_{dfm_res}_{bathy}_{tidemodel}_{CF_SLR}_{wind_forcing}_{CF_wind}",submit_script_system),
    output: 
        dir_event_model = directory(join(root_dir, dir_runs, "{region}", "{runname}", "dfm", "event_{dfm_res}_{bathy}_{tidemodel}_{CF_SLR}_{wind_forcing}_{CF_wind}")),
        mdu_file = join(root_dir, dir_runs, "{region}", "{runname}", "dfm", "event_{dfm_res}_{bathy}_{tidemodel}_{CF_SLR}_{wind_forcing}_{CF_wind}", "event_{dfm_res}_{bathy}_{tidemodel}_{CF_SLR}_{wind_forcing}_{CF_wind}.mdu"),
        submit_script = join(root_dir,dir_runs,"{region}", "{runname}","dfm", "event_{dfm_res}_{bathy}_{tidemodel}_{CF_SLR}_{wind_forcing}_{CF_wind}",submit_script_system),
    script:
...
rule run_dfm:
    input:
        submit_script = join(root_dir,dir_runs,"{region}", "{runname}","dfm", "event_{dfm_res}_{bathy}_{tidemodel}_{CF_SLR}_{wind_forcing}_{CF_wind}",submit_script_system),
    params:
        dir_event_model = directory(join(root_dir, dir_runs, "{region}", "{runname}", "dfm", "event_{dfm_res}_{bathy}_{tidemodel}_{CF_SLR}_{wind_forcing}_{CF_wind}_test")),
        submit_script_copy = join(root_dir,dir_runs,"{region}", "{runname}","dfm", "event_{dfm_res}_{bathy}_{tidemodel}_{CF_SLR}_{wind_forcing}_{CF_wind}_test",submit_script_system_copy),    
    output:
        his_file = join(root_dir, dir_runs, "{region}", "{runname}", "dfm", "event_{dfm_res}_{bathy}_{tidemodel}_{CF_SLR}_{wind_forcing}_{CF_wind}", "output", "event_{dfm_res}_{bathy}_{tidemodel}_{CF_SLR}_{wind_forcing}_{CF_wind}_0000_his.nc"),        
    run:
        if os.name == 'nt':
            print("Executing DFM...")
...
rule add_dfm_output_to_catalog:
    ...
    params:
        ...
        root_dir         = disk_dir,
    output:
        done_file = join(root_dir, dir_runs, "{region}", "{runname}", "dfm", "event_{dfm_res}_{bathy}_{tidemodel}_{CF_SLR}_{wind_forcing}_{CF_wind}", "postprocessing_done.txt"),
    script:
