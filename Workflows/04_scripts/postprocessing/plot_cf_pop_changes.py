...
file_cf0 = BASE_RUN_PATH / EVENT_NAME / "fiat" / "event_tp_era5_hourly_CF0_GTSMv41opendap_CF0_no_wind_CF0" / "output" / "spatial_with_pop_and_flood.fgb"
file_cf8 = BASE_RUN_PATH / EVENT_NAME / "fiat" / "event_tp_era5_hourly_CF-8_GTSMv41opendap_CF0_no_wind_CF0" / "output" / "spatial_with_pop_and_flood.fgb"
...
if use_cartopy:
    scatter_factual = ax_factual.scatter(merged['x'], merged['y'], c=merged[f'{POPULATION_COLUMN}_cf0'], 
