...
# Load config file
config_file = "../../../01_config_snakemake/config_general_mzb_Idai.yml"
...
print(x_DFM.dtype)
print(y_DFM_wl.dtype)

print(np.isnan(x_DFM).sum())
print(np.isnan(y_DFM_wl).sum())

print(np.isfinite(x_DFM).sum())
print(np.isfinite(y_DFM_wl).sum())
