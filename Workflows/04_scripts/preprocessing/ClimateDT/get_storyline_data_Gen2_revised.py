...
for p in ["/tmp", tempfile.gettempdir(), "/var/lib/containers"]:
    try:
        ...
        print(p, f"total={usage.total/1e9:.1f} GB", f"free={usage.free/1e9:.1f} GB")
...
#%%
bbox_SI = [10, -40, 135, 0] # (based on IBTrACS: https://www.ncei.noaa.gov/sites/default/files/2025-04/IBTrACS_version4r01_Technical_Details.pdf)
areaname = 'SI_basin'

params = [235055, 151, 165, 166, 
        #   167, 235035, 235053
          ] # total precip, msl, u10, v10, 2t, ssrd, tisr
...
request = {
    ...
    "stream": "clte",
    "type": "fc",
    #"param": ["134","207", "167", "168", "235055", "175", "235","235035","235036"],
    # "param": ["207"],
    "time": ["0000", "0100", "0200", "0300", "0400", "0500", "0600", "0700", "0800", 
